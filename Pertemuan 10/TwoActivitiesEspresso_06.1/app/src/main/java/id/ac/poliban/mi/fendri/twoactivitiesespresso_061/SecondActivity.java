package id.ac.poliban.mi.fendri.twoactivitiesespresso_061;
...
public class SecondActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY ="id.ac.poliban.mi.fendri.twoactivitiesespresso_061.extra.REPLY";
