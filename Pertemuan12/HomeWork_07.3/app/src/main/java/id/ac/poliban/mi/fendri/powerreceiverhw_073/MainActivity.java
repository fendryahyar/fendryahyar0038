package id.ac.poliban.mi.fendri.powerreceiverhw_073;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_RANDOM_NUMBER = "id.ac.poliban.mi.fendri.powerreceiverhw_073.RANDOM_NUMBER";
